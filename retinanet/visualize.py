...
def main(args=None):
	...
	parser.add_argument('--csv_val', default="temp.csv", help='Path to file containing validation annotations (optional, see readme)')

	parser.add_argument('--model',default='./checkpoint/retina_fpn_132', help='Path to model (.pt) file.')
