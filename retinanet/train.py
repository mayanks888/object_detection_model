...
def main(args=None):
	...
	parser.add_argument('--csv_train',default="/home/mayank-s/Desktop/berkely_small.csv", help='Path to file containing training annotations (see readme)')
	parser.add_argument('--csv_classes',default="/home/mayank-s/Desktop/berkely_class.csv", help='Path to file containing class list (see readme)')
